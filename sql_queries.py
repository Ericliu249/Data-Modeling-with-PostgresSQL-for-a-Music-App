...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays
                            (
                                ...
                                user_id INT NOT NULL, level VARCHAR NOT NULL, song_id VARCHAR NOT NULL,
                                artist_id VARCHAR NOT NULL, session_id INT NOT NULL, location VARCHAR, 
...
user_table_create = ("""CREATE TABLE IF NOT EXISTS users
                        (
                            user_id INT PRIMARY KEY, first_name VARCHAR NOT NULL, 
